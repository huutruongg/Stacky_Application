...
const handleUserOAuth = (provider, providerId, email, displayName, accessToken) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield candidate_service_1.default.getCandidateByEmail(email);
    if (user) {
        yield candidate_service_1.default.updateOauth(provider, providerId, accessToken, user.candidate_id);
        return user;
    }
    else {
        const newUser = yield candidate_service_1.default.createCandidate(email, displayName);
        yield candidate_service_1.default.updateOauth(provider, providerId, accessToken, newUser.candidate_id);
        return newUser;
    }
});
...
passport_1.default.deserializeUser((id, done) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield candidate_service_1.default.getCandidateById(id);
        done(null, user);
    }
    catch (err) {
        done(err);
