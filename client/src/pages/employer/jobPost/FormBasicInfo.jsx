...
const FormBasicInfo = ({ form }) => {
  const [jobImage, setJobImage] = useState(null); // Changed to null
  ...
  return (
    <div className="bg-secondary p-5 rounded-xl">
      ...
      <div className="grid grid-cols-12 gap-5 px-10">
        <div className="grid items-center col-start-1 col-end-6 gap-5">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <ImageUploader
                    id="jobImage" // Unique ID for cover image
                    value={jobImage}
                    onChange={(images) => {
                      setJobImage(images);
        ...
        <div className="grid col-start-6 col-end-13 w-full gap-5">
          {/* Job Name Field */}
          <InputField
            control={form.control}
            name="jobTitle"
