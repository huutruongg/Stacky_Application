...
const FormWorkExperience = ({ form, hasExperience, setHasExperience }) => {
      ...
      <div className="flex gap-10">
        ...
        <div className="flex gap-5 items-center justify-center">
          <Button
            ...
            onClick={() => toggleExperience(false)}
          >
            Chưa có kinh nghiệm
          </Button>
          <Button
        ...
        <div className="grid col-start-1 col-end-10 w-full gap-5">
          ...
          <div className="flex items-center justify-center">
            {hasExperience && (
              <Button
                kind="primary"
                className="className={`flex items-center gap-3 w-fit px-5"
                onClick={() =>
                  append({
                    companyName: "",
                    startDate: null,
