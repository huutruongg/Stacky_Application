...
const FormProfile = ({ form }) => {
  ...
  return (
    <div className="bg-secondary p-5 rounded-xl">
      ...
      <div className="grid grid-cols-12 py-10 gap-5 px-10">
        ...
        <div className="grid col-start-9 col-end-13 w-full items-center justify-center px-10">
          <FormField
            control={form.control}
            name="avatarUrl"
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <ImageUploader
                    id="avatarUrl" // Unique ID for cover image
                    value={cvImage}
                    onChange={(images) => {
                      setCvImage(images);
                      field.onChange(images); // Update form value on image change
                    }}
                  />
                </FormControl>
                <FormMessage />
