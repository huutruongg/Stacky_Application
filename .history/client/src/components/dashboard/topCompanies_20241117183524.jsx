...
import Cmclogo from '../icons/Cmc.png';
import Nashtechlogo from '../icons/NashTech.png';
import Viettellogo from '../icons/Viettel.png';

const TopCompanies = () => {
    const companies = [
        { logo: Fptlogo, name: 'FPT Software', field: 'Phát triển Phần mềm', growth: '+100%' },
        { logo: Cmclogo, name: 'CMC Corporation', field: 'Tích hợp hệ thống', growth: '+95%' },
        { logo: Nashtechlogo, name: 'NashTech', field: 'Phát triển phần mềm', growth: '+89%' },
        { logo: Viettellogo, name: 'Viettel', field: 'Phát triển phần mềm', growth: '+89%' },
